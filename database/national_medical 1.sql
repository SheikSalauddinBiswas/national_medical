...
(3, 'Shakrul Imram', 'shakrul@gmail.com', '01642766002', '1234', '1671977661881.jpg');
...
INSERT INTO `developer` (`id`, `title`, `description`, `image`) VALUES
(2, 'Sheik Salauddin Biswas', 'Group Leader of National Medical', 'IMG_20220729_135425.jpg');
...
(1, 'Dr . Md . Mahbub Khan		', 'Cardiologist', '15 years Experiences', 'image 2.jpg'),
(2, 'Dr . Md . Fajlul Haq', 'Gynecologist', '18 years Experiences M.B.B.S', 'image 4.jpg'),
(3, 'Dr . Md . Anamul Haq		', 'Cardiologist', '18 years Experiences M.B.B.S', 'images5.jpg'),
(4, 'Dr. Md . Abul Hasnat', 'Orthopedic Surgeon', '	17 years Experiences M.B.B.S', 'image 8.jpg'),
(7, 'Dr . Md . Kazi Faiyadul Karim	', '	Oncologist', '12 years Experiences M.B.B.S', 'images7.jpg'),
(8, 'Dr . Md . Jahangir Talukdar	', 'Psychiatrist	', '15 years Experiences M.B.B.S', 'images6.jpg'),
(9, 'Dr . Md . Nuruddin Ahmed', 'Anesthesiologist', '17 years Experiences  M.B.B.S', 'image.jpg'),
(10, 'Dr . Tanha Tasnim	', 'Medicine', '15 years Experiences  M.B.B.S', 'images.jpg');
...
(2, 'cardiac clinic', 'We came across patients with many cardiac disorders regularly. Most of the time, people come to us for treatment, but there are cases when people reach us out for consultation as well. ', 'caR.jpg'),
(3, 'plastic surgery', 'During each Plastic Surgery Camp on average 190 operations are performed. Due to this work the children and grown-ups who had an operation will have a better and dignified life', 'sur.jpg'),
(4, 'dental clinic', 'Welcome you to our website! At national Medical, our philosophy is to provide treatment to the whole person - with a special focus on how your teeth and gums relate to your total body health.', 'dentist.jpg');
...
(1, 'Welcome to our clinic', 'National Medical has all the characteristics of a world-class hospital with wide range of services and specialists, equipments and technology, ambience and service quality.', 'About-India-12.jpg');
