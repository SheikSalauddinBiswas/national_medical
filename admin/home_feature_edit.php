<?php 
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM home_feature WHERE id='$id'";
    $result = $db->query($sql);
...
?>
  <div class="" id="content">
    <div class="">
        <div class="">
        <h1 class="text-secondary pl-5 pt-3"><span class="fa fa-address-card-o text-info" ></span>Home Feature Edit<hr></h1> 
        </div>
    </div><hr>
    <br><br>
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <form method="POST" action="home_feature_update.php" role="form" enctype="multipart/form-data">
