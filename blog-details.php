    ...
    <section class="banner-area other-page">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Blog Details</h1>
                    <a href="index.php">Home</a> <span>|</span> <a href="blog-details.php">Blog Details</a>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <div class="media post_item">
                                ...
                                <div class="media-body">
                                    <a href="blog-details.php"><h5>Space The Final Frontier</h5></a>
                                    <p>02 Hours ago</p>
                                </div>
                            </div>
                            <div class="media post_item">
                                ...
                                <div class="media-body">
                                    <a href="blog-details.php"><h5>The Amazing Hubble</h5></a>
                                    <p>02 Hours ago</p>
                                </div>
                            </div>
                            <div class="media post_item">
                                ...
                                <div class="media-body">
                                    <a href="blog-details.php"><h5>Astronomy Or Astrology</h5></a>
                                    <p>03 Hours ago</p>
                                </div>
                            </div>
                            <div class="media post_item">
                                ...
                                <div class="media-body">
                                    <a href="blog-details.php"><h5>Asteroids telescope</h5></a>
                                    <p>01 Hours ago</p>
                                </div>
                            </div>
                            <div class="br"></div>
